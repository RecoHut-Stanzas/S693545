...
class HMLET_All(nn.Module):
	...
	def computer(self, gum_temp, hard):     
		...
		gumbel_out_1, lin_count_1, non_count_1 = self.gating_network_list[0](concat_embeddings_1, gum_temp, hard, self.config['division_noise'])
		...
		gumbel_out_2, lin_count_2, non_count_2 = self.gating_network_list[1](concat_embeddings_2, gum_temp, hard, self.config['division_noise'])
		...
		gumbel_out_3, lin_count_3, non_count_3 = self.gating_network_list[1](concat_embeddings_3, gum_temp, hard, self.config['division_noise'])
		...
		gumbel_out_4, lin_count_4, non_count_4 = self.gating_network_list[1](concat_embeddings_4, gum_temp, hard, self.config['division_noise'])
    ...
    ## Stack & mean residual embeddings
		...
		return users, items, [lin_count_1, non_count_1, lin_count_2, non_count_2, lin_count_3, non_count_3, lin_count_4, non_count_4], embs
