...
class HMLET_Middle(nn.Module):
	...
	def computer(self, gum_temp, hard):     
		...
		all_emb_non_2 = self.activation_function(torch.sparse.mm(g_droped, all_emb_lin_1))

		# Gating
		stack_embedding_1 = torch.stack([all_emb_lin_2, all_emb_non_2],dim=1)
		concat_embeddings_1 = torch.cat((all_emb_lin_2, all_emb_non_2),-1)

		gumbel_out_1, lin_count_2, non_count_2 = self.gating_network_list[1](concat_embeddings_1, gum_temp, hard, self.config['division_noise'])
		...
		all_emb_non_3 = self.activation_function(torch.sparse.mm(g_droped, embedding_1))

		# Gating
		stack_embedding_2 = torch.stack([all_emb_lin_3, all_emb_non_3],dim=1)
		concat_embeddings_2 = torch.cat((all_emb_lin_3, all_emb_non_3),-1)

		gumbel_out_2, lin_count_3, non_count_3 = self.gating_network_list[1](concat_embeddings_2, gum_temp, hard, self.config['division_noise'])
		...
		return users, items, [lin_count_2, non_count_2, lin_count_3, non_count_3], embs
